...
* 用来进行查看已点菜目，并进行修改和提交
*/
public class Item1_TuiJianActivity extends Activity {
	private final String table_name = Constant.table_tuijian;
...
//										+ "/DianCan/db/DianCan.db3"; 
	...
	*/
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tui_jian);
        sp = Item1_TuiJianActivity.this.getSharedPreferences("DianCan", Context.MODE_PRIVATE);
	...
	*/
	...
	protected void onResume() {
        ...
        list = (ListView)findViewById(R.id.food_list_tuijian);
		try {
...
//		Bundle args = getArguments();
		ListButtonAdapterA adapter = new ListButtonAdapterA( 
				this, 
