...
* @see com.mlq.diancan.ListButtonAdapter1
* @see com.mlq.diancan.Item1_YiDianActivity
*/
public class ListButtonAdapter3 extends BaseAdapter { 	
    ...
    public ListButtonAdapter3( Context c, String mtable_name, SqliteDbHelper mdbHelper, 
