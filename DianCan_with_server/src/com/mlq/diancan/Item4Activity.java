...
//        resources = getResources();
        final EditText restaurant_name_ev = (EditText)findViewById(R.id.item4_edit1);
        final EditText waiter_num_ev = (EditText)findViewById(R.id.item4_edit2);
        final Button ok_btn = (Button)findViewById(R.id.item4_ok_btn);
        Button back_btn = (Button)findViewById(R.id.item4_back_btn);
        sp = Item4Activity.this.getSharedPreferences("DianCan", Context.MODE_PRIVATE);
